...
class Response
{
    ...
    protected $_arRecommendedReasonPhrases = array(
        // INFORMATIONAL CODES
        100 => 'Continue',
    ...
    protected $_sDatatype = 'html';
    protected $_iStatusCode;
    protected $_sReasonPhrase;

    public function setDatatype(String $sType)
    {
        $this->_sDatatype = $sType->__toString();
    ...
    {
        return new String($this->_sDatatype);
    }
    ...
    */
    ...
    {
        if ($this->_sReasonPhrase == null)
        {
            return $this->_arRecommendedReasonPhrases[$this->statusCode];
        }
        return $this->_sReasonPhrase;
    }
    ...
    public function sendJson(array $arHeader, $sBody)
    {
        ...
        $arResponse = array('header' => $arHeader,
                            'body' => $sBody);
